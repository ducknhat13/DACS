...
class PollController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // Map choice_type to allow_multiple
        ...
        // For image polls, set allow_multiple to true and use max_image_selections
        ...
        $poll = Poll::create([
            ...
            'max_choices' => $validated['max_choices'] ?? null,
            'max_image_selections' => $validated['max_image_selections'] ?? null,
        ...
        if ($validated['poll_type'] === 'image') {
            // For image polls, create options with image data
            ...
            for ($i = 0; $i < count($imageOptionTexts); $i++) {
                ...
                // Only include image data if we have a valid URL
                $optionData[] = [
            ...
            // For regular polls, create text-only options
    ...
    public function exportCsv(string $slug)
    {
        ...
        $callback = function () use ($poll) {
            ...
            fputcsv($out, ['Poll Type', $pollTypeText]);
